...
Pointset.listAll = function(projectId, simple, order_by) {
  return CATMAID_fetch(projectId + '/pointsets/', 'GET', {
    simple: !!simple,
    order_by: order_by,
  });
};
...
Pointset.list = function(projectId, simple, pointsetIds) {
  return CATMAID_fetch(projectId + '/pointsets/', pointsetIds ? 'POST' : 'GET', {
    simple: !!simple,
...
Pointset.get = function(projectId, pointsetId, withPoints) {
  return CATMAID_fetch(projectId + '/pointsets/' + pointsetId + '/', 'GET', {
