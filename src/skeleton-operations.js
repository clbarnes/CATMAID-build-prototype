  ...
  */
  this.setFilters = function(modeSetting) {
    ...
    if (state.metaAnnotationName !== null) {
      CATMAID_annotatedSkeletons.unregister(state.metaAnnotationName, state.callback, true);
    }
    ...
    if (modeSetting.hasOwnProperty('metaAnnotationName')) {
      ...
      CATMAID_annotatedSkeletons.register(state.metaAnnotationName, state.callback, true);
  ...
  */
  this.refresh = function () {
    ...
    if (this.state.metaAnnotationName) {
      jobs.push(CATMAID_annotatedSkeletons.refresh(this.state.metaAnnotationName, true));
    }
