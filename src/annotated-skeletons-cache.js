...
AnnotatedSkeletonsCache.prototype._getTrackedAnnotation = function (annotationName) {
  if (!this.trackedAnnotations.hasOwnProperty(annotationName)) {
    throw new CATMAID_ValueError('Annotation is not tracked by cache: ' + annotationName);
  }
  ...
  var refreshWithMeta = function(includeMeta) {
    ...
    return CATMAID
        ...
        .then(function (json) {
          ...
          if (!CATMAID_tools.areSetsEqual(tracked.skeletonIDs[includeMeta ? 1 : 0], newSkeletonIds)) {
