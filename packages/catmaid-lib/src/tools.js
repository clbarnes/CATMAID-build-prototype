 ...
 */
export let compareStrings = function(str1, str2)
{
 ...
 */
export let compareNumbers = function(a, b) {
  return a - b;
};
 ...
 */
export let compareHSLColors = function(hsl1, hsl2)
{
  if (hsl1.h === hsl2.h) {
    if (hsl1.s === hsl2.s) {
      if (hsl1.l === hsl2.l) {
 ...
 * integer is negative.
 */
export let parseIndex = function(str) {
  var pattern = /(\d+)$/;
 ...
 */
export let urlJoin = function(a, b) {
  if (a) {
    if (b) {
      if (a[a.length - 1] === '/') {
        if (b[0] === '/') {
 ...
 * properties.
 */
export let parseQuery = function(url) {
  if (url) {
    var r, query;
    query = /\?(.*?)$/i;
 ...
 */
export let extend = function(subclass, superclass) {
   function Dummy() {}
 ...
 */
export let dataURItoBlob = function(dataURI) {
 ...
 */
export let createImageFromGlContext = function(gl, width, height, texture) {
    var framebuffer;
    if (texture) {
 ...
 * are defined.
 */
export let copyIfDefined = function(source, target, sourceField, targetField, mapFn) {
 ...
 */
export let setXYZ = function(obj, value) {
 ...
 */
export let callIfFn = function(fn) {
  if (isFn(fn)) {
 ...
 */
export let cssColorToRGB = function(cssColor) {
 ...
 */
export let rgbToHex = function(r, g, b) {
  // See http://stackoverflow.com/questions/5623838
 ...
 */
export let rgbToLuminance = function(r, g, b) {
 ...
 */
export let getContrastColor = function(hex, getHex) {
  var rgb = hexToRGB(hex);
  var lum = rgbToLuminance(rgb.r, rgb.g, rgb.b);
  if (getHex) {
 ...
 * a THREE.js plane.
 */
export let intersectLineWithPlane = function(x1, y1, z1, x2, y2, z2, plane, target) {
 ...
 */
export let sameSign = function(a, b)
{
  return (a < 0) === (b < 0);
};
 ...
 */
export let contextualDateString = (function () {
  var MINUTE = 60000;
  var HOUR = 60 * MINUTE;
  var DAY = 24 * HOUR;
 ...
 * YYYY-MM-DD hh:mm:ss.
 */
export let dateToString = function(d) {
  var day = d.getDate();
  if (day < 10) day = '0' + day;
 ...
 * assumed.
 */
export let isoStringToDate = (function() {
...
export let numberSuffix = function(n) {
  return n > 1 ? 's' : '';
};
 ...
 */
export let humanReadableTimeInterval = (function() {
 ...
 */
export let escapeRegEx = (function() {
 ...
 */
export let listToIdMap = (function() {
 ...
 * passed in default.
 */
export let getDefined = function(value, fallback) {
 ...
 * are copied as well.
 */
export let cloneNode = function(element, copyStyle) {
  ...
  for (var i=0, length=element.childNodes.length; i<length; ++i) {
    ...
    var childClone = cloneNode(child, copyStyle);
 ...
 */
export let printElement = function(element) {
  ...
  var clone = cloneNode(element, true);
 ...
 * map/etc.
 */
export let trimString = function(str) {
  return str.trim();
};
 ...
 */
export let areSetsEqual = function (a, b) {
  if (a === b) return true;
  if (!a || !b) return false;
 ...
 * target.
 */
export let updateFromDefaults = function(target, defaults) {
...
export let getDateSuffix = function() {
  var now = new Date();
 ...
 * well.
 */
export let validateNumber = function(number, errorMessage, min, max) {
 ...
 */
export let arraysEqual = function(a, b) {
  if (!a || !b) {
    return false;
  }
 ...
 */
export let permute = function(arr, perm) {
 ...
 */
export let permuteCoord = function(obj, perm) {
 ...
 */
export let quote = function(text) {
  return '"' + text + '"';
};
 ...
 * constructor.
 */
export let getColor = function(value) {
 ...
 */
export let copyToClipBoard = function(text) {
 ...
 */
export let getPointBoundingBox = function(points) {
 ...
 */
export let extractFileNameNoExt = function(path) {
  let sep = getOS() === 'WIN' ? '\\' : '/';
 ...
 */
export let buildObject = function (keys, values) {
